...
#         print('checkpoint - total time {}'.format(cnt, total_time))
#         print('total commited', len(ividx_with_freq))
#         time.sleep(5)
#         start_time = time.time()
#
...
#
#     array_with_ntf_vals = ntf[set_of_relevant_docs, idx_for_word].data
#     # array_with_ntf_vals = ntf[idx_for_word].data
#     # print(array_with_ntf_vals)
#     # array_with_ntf_vals = np.squeeze(array_with_ntf_vals)
#     # print(array_with_ntf_vals)
#     # array_with_ntf_vals = list(array_with_ntf_vals.astype(np.float32))
...
#
#     # if cnt<4:
#     #     print('ntf values', array_with_ntf_vals)
#     #     print(tuples_list_with_doc_and_freq)
#
#
#     print(set_key_name)
#     print(tuples_list_with_doc_and_freq)
#
#     # list_with_doc_and_freq = []
#     # for doc_id_val in set_of_relevant_docs:
#     #     normalised_term_f = ntf[doc_id_val, idx_for_word].astype(np.float32)
#     #     normalised_term_f_rounded = normalised_term_f.round(4)
#     #     if cnt < 4:
#     #         print(doc_id_val, normalised_term_f_rounded)
#     #
#     #     tuple_value = (doc_id_val, normalised_term_f_rounded)
#     #     list_with_doc_and_freq.append(tuple_value)
#
#
#
#     try:
...
with SqliteDict('ividx_with_freq.sqlite', decode=decompress_set) as dct:
    print(dct['ividx_قلنج'])

with SqliteDict('ividx_no_freq.sqlite', decode=decompress_set) as dct:
    print(dct['ividx_قلنج'])
